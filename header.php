                    ...
                    <nav class="navbar navbar-expand">
                        ...
                        <div class="user-box dropdown">
                            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="assets/images/avatars/account.svg" class="user-img" alt="user avatar">
                                <div class="user-info ps-3">
                                    <p class="user-name mb-0"><?php if(isset($_SESSION['user_firstname'])){ echo $_SESSION['user_lastname'].' '.$_SESSION['user_firstname'];}?> (<?php if(isset($_SESSION['user_profile'])){ echo $_SESSION['user_profile'];}?>)</p>
                                    <p class="designattion mb-0"><?php if(isset($_SESSION['user_email'])){ echo $_SESSION['user_email'];}?></p>
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end">
                                    <!--<li><a class="dropdown-item" href="javascript:;"><i class="bx bx-user"></i><span>Profil</span></a>
                                </li>
                                <li><a class="dropdown-item" href="javascript:;"><i class="bx bx-cog"></i><span>Modifier le mot de passe</span></a>
                                </li>
                            <li><a class="dropdown-item" href="javascript:;"><i class='bx bx-home-circle'></i><span>Dashboard</span></a>
                                ...
                                <li style="cursor:pointer;"><a class="dropdown-item"  id="btn-disconnect"><i class='bx bx-log-out-circle'></i><span>Déconnexion</span></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
